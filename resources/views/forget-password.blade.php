                                ...
                                <td width="100%" align="center">
                                            ...
                                            <tr>
                                                <td align="center" bgcolor="#ffffff">
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                                                        <tbody>
                                                            <tr>
                                                                <td width="100%" height="7" align="center" border="0" bgcolor="#4e5052"></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <!-- END BORDER COLOR -->
                                                    ...
                                                    <table width="200" border="0" cellpadding="0" cellspacing="0" align="center">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                href="http:4300/reset-password/<?php echo $token; ?>">Reset Password</a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
                                                        <tbody>
                                                            <tr>
                                                                <td width="100%" align="center">
                                                                    <p style="font-family:'Ubuntu', sans-serif; font-size:14px; color:#202020; padding-left:20px; padding-right:20px; text-align:justify;">If the above button doesn't work, you can reset your password by clicking the following link, <a   href="http:4300/reset-password/<?php echo $token; ?>">Reset password</a>.</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                                        <tbody>
                                            <tr>
                                                <!-- <td width="100%" align="center">
                                                    <a href="#"><img width="25" height="25" src="https://codewiz.co/img/email_templates/facebook_icon.png" alt="Facebook" border="0" style="text-align: center;"/></a>
                                                    <a href="#"><img width="25" height="25" src="https://codewiz.co/img/email_templates/twitter_icon.png" alt="Twitter" border="0" style="text-align: center;"/></a>
                                                    <a href="#"><img width="25" height="25" src="https://codewiz.co/img/email_templates/linkedin_icon.png" alt="LinkedIn" border="0" style="text-align: center;"/></a>
                                                    <a href="#"><img width="25" height="25" src="https://codewiz.co/img/email_templates/instagram_icon.png" alt="Instagram" border="0" style="text-align: center;"/></a>
                                                    <a href="#"><img width="25" height="25" src="https://codewiz.co/img/email_templates/youtube_icon.png" alt="Youtube" border="0" style="text-align: center;"/></a>
                                                    <a href="#"><img width="25" height="25" src="https://codewiz.co/img/email_templates/google_plus_icon.png" alt="Google Plus" border="0" style="text-align: center;"/></a>
                                                    <a href="#"><img width="25" height="25" src="https://codewiz.co/img/email_templates/behance_icon.png" alt="Behance" border="0" style="text-align: center;"/></a>
                                                    <a href="#"><img width="25" height="25" src="https://codewiz.co/img/email_templates/github_icon.png" alt="Github" border="0" style="text-align: center;"/></a>
                                                </td> -->
                                            </tr>
                                        </tbody>
                                    </table>
